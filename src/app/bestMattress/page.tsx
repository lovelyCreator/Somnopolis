            ...
            <div className="flex min-h-screen flex-col items-center justify-start w-full">
                ...
                <div className="block text-center w-full mb-[20px] pl-[10%] lg:flex">
                    <div className="w-full lg:w-[65%]">
                        ...
                        <div className="w-[90%]">
                            <div className={`${styles.manropeFont} text-[#1A1D20] text-[2vw] lg:text-[24px] text-wrap text-left pb-[5%]`}>
                                <p className="border-b-2 border-[#324983] pb-2 font-bold">
                                    Ce que nous recherchons dans les meilleurs matelas
                                </p>
                                <div className={`${styles.rubikFont} text-[#1A1D20] text-[2vw] lg:text-[16px] text-left text-wrap w-[100%] pt-5`}>
                                    <p className="font-bold">&nbsp;&nbsp;&nbsp;-&nbsp;&nbsp;&nbsp;   Notre méthodologie</p>
                                    <p className={`${styles.rubikFont} text-[#1A1D20] text-[2vw] lg:text-[16px] text-left text-wrap w-[90%] pt-2 ml-[5%]`}>
                                ...
                                <div className={`${styles.rubikFont} text-[#1A1D20] text-[2vw] lg:text-[16px] text-left text-wrap w-[100%] pt-10`}>
                                    <p className="font-bold">&nbsp;&nbsp;&nbsp;-&nbsp;&nbsp;&nbsp;   Fermeté et position de sommeil</p>
                                    <p className={`${styles.rubikFont} text-[#1A1D20] text-[2vw] lg:text-[16px] text-left text-wrap w-[90%] pt-2 ml-[5%]`}>
                                ...
                                <div className={`${styles.rubikFont} text-[#1A1D20] text-[2vw] lg:text-[16px] text-left text-wrap w-[100%] pt-10`}>
                                    <p className="font-bold">&nbsp;&nbsp;&nbsp;-&nbsp;&nbsp;&nbsp;   Types de matelas les plus courants</p>
                                    <p className={`${styles.rubikFont} text-[#1A1D20] text-[2vw] lg:text-[16px] text-left text-wrap w-[90%] pt-2 ml-[5%]`}>
                        ...
                        <div className="overflow-scroll overflow-y-scroll mt-2 w-[90%] mb-20">
                                ...
                                <tr className="overflow-x-scroll">
                                    <th className="px-6 py-3 bg-gray-50 text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider text-center border border-gray-200"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
                                    {
                                        compareData.map((item:any, index:any) =>
                                            <th className="px-6 py-3 bg-gray-50 text-center text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider border border-gray-200 w-[500px]">
                                                <img
                            ...
                            <tbody className={`${styles.rubikFont} divide-y divide-gray-200`}>
                                <tr>
                                    <td className="px-6 py-3 bg-gray-50 text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider text-center border border-gray-200">Rating</td>
                                ...
                                <tr>
                                    <td className="px-6 py-3 bg-gray-50 text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider text-center border border-gray-200">Firmness</td>
                                    {
                                    compareData.map((item:any, index:any) =>
                                        <td className={`px-6 py-2 whitespace-no-wrap border text-xs border-gray-200 text-center bg-white}`}>
                                            {item.firmness}
                                        </td>
                                    )}
                                </tr>
                                ...
                                <tr>
                                    <td className="px-6 py-3 bg-gray-50 text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider text-center border border-gray-200">Material</td>
                                    {
                                    compareData.map((item:any, index:any) =>
                                        <td className={`px-6 py-2 whitespace-no-wrap border text-xs border-gray-200 text-center bg-white}`}>
                                            {item.material}
                                ...
                                <tr>
                                    <td className="px-6 py-3 bg-gray-50 text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider text-center border border-gray-200">Cooling</td>
                                    {
                                    compareData.map((item:any, index:any) =>
                                        <td className={`px-6 py-2 whitespace-no-wrap border text-xs border-gray-200 text-center bg-white}`}>
                                            {item.cooling}
                                ...
                                <tr>
                                    <td className="px-6 py-3 bg-gray-50 text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider text-center border border-gray-200">Sleep Position</td>
                                    {
                                    compareData.map((item:any, index:any) =>
                                        <td className={`px-6 py-2 whitespace-no-wrap border text-xs border-gray-200 text-center bg-white}`}>
                                            {item.sleep_position}
                        ...
                        <div className="w-[90%]">
                                ...
                                <div className="block md:flex justify-center items-start text-center ml-[12.5%] gap-[5%] pl-[10px] pr-[10px] pt-[2%] bg-white pb-[20px] rounded-[10px] w-[70%]">
                                    <div className="flex flex-row justify-start items-start w-[50%]">
                                        <Image
                                            ...
                                            className="w-[65px]"
                                        />
                                        <div className={`${styles.manropeFont} text-[#1A1D20] text-[2vw] lg:text-[16px] font-bold text-wrap pl-[5%] text-left`}>
                                            Matériel
                            ...
                            <div className={`${styles.manropeFont} text-[#1A1D20] text-[2vw] lg:text-[20px] text-wrap text-left pt-[5%]`}>
                                <p className="font-bold">Opinion d'expert</p>
                                <hr className="w-[15%] bg-[#5ca9e8] my-2 "></hr>
                                <p className={`${styles.rubikFont} text-[#1A1D20] text-[2vw] lg:text-[16px] 
                                text-left text-wrap w-[100%]`}>
                            ...
                            <div className={`${styles.manropeFont} text-[#1A1D20] text-[2vw] lg:text-[16px] text-wrap mt-[5%] text-left px-4 bg-[#eef5f9] py-8 rounded-lg`}>
                                <span className="font-bold">Ce que dit notre testeur :</span> 
                                <span className={`${styles.rubikFont} text-[#1A1D20] text-[2vw] lg:text-[16px] 
                                text-left text-wrap w-[100%]`}>
                                    &nbsp;“I love that the Sensoreve Elekctra offers solid edge support — you can use the whole bed! It also has great motion isolation, which makes it a nice option for couples. I also really like this bed for combination sleepers. The mattress is bouncy, making it easy for you to roll over or switch positions at night without worrying that you’ll get ‘stuck’ in the bed.” –&nbsp;
                                </span>
                            ...
                            <div className={`${styles.manropeFont} text-[#1A1D20] text-[2vw] lg:text-[20px] text-wrap text-left pt-[5%]`}>
                                ...
                                <p className={`${styles.rubikFont} text-[#1A1D20] text-[2vw] lg:text-[16px] text-left text-wrap pt-5`}>
                        ...
                        <div className="w-[90%]">
                            <div className={`${styles.manropeFont} text-[#1A1D20] text-[2vw] lg:text-[24px] text-wrap text-left pt-[5%]`}>
                                <p className="border-b-2 border-[#324983] pb-2 font-bold">
                            ...
                            <div className={`${styles.manropeFont} text-[#1A1D20] text-[2vw] lg:text-[24px] text-wrap mt-[5%] text-left px-4 bg-[#eef5f9] py-8 rounded-lg`}>
                                <p className="font-bold">Comment votre matelas peut-il soulager la douleur ?</p>
                                <p className={`${styles.rubikFont} text-[#1A1D20] text-[2vw] lg:text-[16px] text-left text-wrap w-[100%]`}>
                                ...
                                <div className="flex flex-row w-full items-start justify-left">
                                    ...
                                    <div className={`${styles.rubikFont} text-[#1A1D20] text-[2vw] lg:text-[16px] text-left text-wrap`}>
                        ...
                        <div className="w-[90%]">
                            ...
                            <div className={`${styles.manropeFont} text-[#1A1D20] text-[2vw] lg:text-[20px] text-wrap text-left pt-[5%]`}>
                                ...
                                <p className={`${styles.rubikFont} text-[#1A1D20] text-[1vw] lg:text-[12px] 
                        ...
                        <div className="w-[90%]">
                            ...
                            <div className={`${styles.manropeFont} text-[#1A1D20] text-[2vw] lg:text-[24px] text-wrap mt-[5%] text-left px-4 bg-[#eef5f9] py-8 rounded-lg`}>
                                ...
                                <p className={`${styles.rubikFont} text-[#1A1D20] text-[2vw] lg:text-[16px] text-left text-wrap w-[100%] my-3 mb-5`}>
                        ...
                        <div className="w-[90%]">
                            ...
                            <div className={`${styles.manropeFont} text-[#1A1D20] text-[2vw] lg:text-[24px] text-wrap mt-[5%] text-left px-4 bg-[#eef5f9] py-4 rounded-lg`}>
